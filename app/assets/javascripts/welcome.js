                    ...
                    if (cat ==0 && deg == 0){
                              ...
                              for (var count in myprojects) {
                                        ...
                                        var catdata = localtimesheets.filter(function (t) {
                                                  if (task== 0) {
                                                            return getTaskById(t.user_id).task_category == cat;
                                                  }else if (task !=0){
                                                            return (getTaskById(t.user_id).task_category == cat) && (t.task_id ==task) ;
                                                  }
                                        });
                                        var myd = d3.nest()
                                                  .key(function (d) {
                              ...
                              for (var count in myprojects) {
                                        ...
                                        var catdata = localtimesheets.filter(function (t) {
                                                  if (task== 0) {
                                                            return (getTaskById(t.user_id).task_category == cat) && (getUserById(t.user_id).designation == deg) ;
                                                  }else if (task !=0){
                                                            return (getTaskById(t.user_id).task_category == cat) && (t.task_id ==task) && (getUserById(t.user_id).designation == deg) ;
                                                  }
                                        });
                                        var myd = d3.nest()
                                                  .key(function (d) {
